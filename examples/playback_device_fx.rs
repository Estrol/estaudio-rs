...
fn main() {
    ...
    engine.set_attribute_bool(AudioAttributes::AudioFX, true).expect("Failed to set audio FX");
    engine.set_attribute_f32(AudioAttributes::FXPitch, 1.25).expect("Failed to set pitch");
